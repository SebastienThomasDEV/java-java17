...
public class Stream_02_Test {
	...
	public void test_map() throws Exception {
		...
		// exemple de référence de méthode : Order::getCustomer
		// revient à écrire : o -> o.getCustomer()
	...
	public void test_mapToDouble_sum() throws Exception {
		 ...
		 * commandes)
		 */
		double result = orders.stream().map(Order::getPrice).mapToDouble(Double::doubleValue).sum();
	...
	public void test_mapToDouble_avg() throws Exception {
		 ...
		 */
		OptionalDouble result = orders.stream().map(Order::getPrice).mapToDouble(Double::doubleValue).average();
