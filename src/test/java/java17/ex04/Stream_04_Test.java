...
public class Stream_04_Test {
    ...
    public void test_builder() throws Exception {
        ...
        result.add("Alexandra");
        result.add("Cyril");
        result.add("Johnny");
        result.add("Marion");
        result.add("Sophie");
        Stream<String> result2 = result.build();
        assertThat(result2.toArray(), arrayContaining("Alexandra", "Cyril", "Johnny", "Marion", "Sophie"));
    }
