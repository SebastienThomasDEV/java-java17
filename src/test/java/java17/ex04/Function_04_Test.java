...
public class Function_04_Test {
    ...
    public void test_predicate() throws Exception {
        ...
        List<Person> result = filter(personList, isAdult);
    ...
    Predicate<Person> lastnameIsFrance = name -> name.getLastname().equals("France");


    // TODO compléter la fonction
    // TODO le prédicat vérifie que le prénom est "Armor"
    Predicate<Person> firstnameIsArmor = name -> name.getFirstname().equals("Armor");
    // end::predicateand[]
    ...
    public void test_predicate_and() throws Exception {
        ...
        List<Person> result = filter(personList, isAdult.and(lastnameIsFrance).and(firstnameIsArmor));
